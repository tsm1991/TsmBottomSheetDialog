 ...
 * on 2022/2/24
 */
public class ShimmerSkeletonLayout extends FrameLayout {
    ...
    public ShimmerSkeletonLayout(Context context) {
        this(context, null);
    }

    public ShimmerSkeletonLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShimmerSkeletonLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.ShimmerSkeletonLayout,
                0, 0);

        try {
            shimmerAngle = a.getInteger(R.styleable.ShimmerSkeletonLayout_shimmer_angle, DEFAULT_ANGLE);
            shimmerAnimationDuration = a.getInteger(R.styleable.ShimmerSkeletonLayout_shimmer_animation_duration, DEFAULT_ANIMATION_DURATION);
            shimmerColor = a.getColor(R.styleable.ShimmerSkeletonLayout_shimmer_color, getColor(R.color.shimmer_color));
            autoStart = a.getBoolean(R.styleable.ShimmerSkeletonLayout_shimmer_auto_start, false);
            maskWidth = a.getFloat(R.styleable.ShimmerSkeletonLayout_shimmer_mask_width, 0.5F);
            gradientCenterColorWidth = a.getFloat(R.styleable.ShimmerSkeletonLayout_shimmer_gradient_center_color_width, 0.1F);
            isAnimationReversed = a.getBoolean(R.styleable.ShimmerSkeletonLayout_shimmer_reverse_animation, false);
        } finally {
            a.recycle();
        }
